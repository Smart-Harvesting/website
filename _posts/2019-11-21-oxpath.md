...
---
In our [previous blog post]({{ site.baseurl }}posts/web-scraping/index.html), we discussed the different options for programmers to create web scrapers in several programming languages.
