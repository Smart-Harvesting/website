...
---
In our [previous blog post]({% post_url 2019-11-20-web-scraping %}), we discussed the different options for programmers to create web scrapers in several programming languages.
...
In our project "[Smart Harvesting II]({% link about/index.md %})", our use case was metadata collection for (digital) libraries.
...
{% link /assets/img/extractionTree.png %}
